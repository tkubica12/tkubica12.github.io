...
- **Kontext** je zásadní, ale hlavní průlom vzniká s uzavřením **zpětnovazební smyčky**, která ve finále vede i k vytváření kontextu. Pokud lze něco dobře změřit, je lepší investovat 80% snahy do měření a jen 20% na kontext (zejména v podobě konstituce a konceptů). Pokud se něco špatně posuzuje, je potřeba investovat 80% snahy do kontextu.
- **Uživatelé se nebudou učit používat váš software**, tohle musí být naopak.

# Evoluce mého domácího projektu
Zkusím popsat jak jsem postupoval a vřele doporučuji si něco takového vyzkoušet - je to zábavné.

## Fáze 1 - Proč se mám učit cizí software, když mít vlastní je jednodušší?
...
## Fáze 2 - Proč jen přidat agenta do software, když to může být obráceně?
...
## Fáze 3 - Proč mám mít webové rozhraní, když můžu mít GenUI?
