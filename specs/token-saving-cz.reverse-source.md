# Reverse-engineered source: token-saving-cz

Status: draft reverse-engineering exercise

This is a proposed `.article.md` source for the reference interactive page at `https://tomaskubica.cz/gh-copilot-demo/talks/token-saving-cz.html`. It is not meant to be a byte-perfect HTML reconstruction. It demonstrates the source format that should let an agent regenerate a close interactive article.
