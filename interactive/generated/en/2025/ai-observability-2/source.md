---
format_version: 1
title: "Deep dive into observability for AI agents - metrics, logs and dashboards with Azure Monitor, Grafana and Application Insights"
eyebrow: "AI observability, part 2"
subtitle: "Metrics, logs, dashboards and backend choices for AI agent observability without unnecessary decoration."
slug: "ai-observability-2"
date: "2025-11-05"
language: "en"
source_language: "cs-CZ"
source_slug: "ai-observability-2"
translation: "machine"
translated_from_hash: "97A3E580D579985EFD3F63E6658A75C5D603BBD75376E5E87C649EFE3CB5B2FF"
translation_status: "current"
status: "experimental"
canonical_url: "/en/2025/ai-observability-2/"
agent_friendly:
  source: "source.md"
  caveman: "caveman.md"
design:
...
::: callout type="verdict" title="Main point"
...
:::
::: group id="orientace" title="Data orientation"

::: card number="01" title="What to observe in agents" default="open"
...
:::
::: card number="04" title="Proč řešit metriky a ne jen trasování: continued" default="open"
...
::: reveal title="Screenshots: built-in and custom metrics"
![Built-in Microsoft Agent Framework metrics](/images/2025/2025-10-27-19-50-14.png)
![Filtering metrics by model and provider dimensions](/images/2025/2025-10-27-19-50-48.png)
![Custom metric for the number of agent calls](/images/2025/2025-10-27-19-51-42.png)
![Custom metric visualization in the dashboard](/images/2025/2025-10-27-19-52-36.png)
:::
::: reveal title="Configuration or output"
```python
...
:::
:::
::: card number="06" title="Instrumentation: continued"
...
![Remote-write sidecar setup example](/images/2025/2025-10-28-11-11-28.png)
...
:::
:::
::: card number="08" title="Azure Managed Grafana over the metrics"
Then I have Azure Managed Grafana on top of it and can start building dashboards.
:::
:::

::: group id="logovani-pres-opentelemetry" title="Logging through OpenTelemetry"

::: card number="09" title="Logging through OpenTelemetry"
The classic way of logging is either collecting stdout or using tools such as Logstash, Fluentd, or native tools of a specific solution such as Graylog or Loki. OpenTelemetry brings unification and standardization, so the same open SDK can be used for tracing, metrics, and logs. At the time of writing Azure Monitor does not yet support logs via OpenTelemetry, but for my exploration of AI agent observability I used OpenTelemetry together with Aspire Dashboard for a quick view.

This is what it looks like in the dashboard.

![Log records in the dashboard](/images/2025/2025-10-28-11-01-54.png)
![Log detail in the dashboard](/images/2025/2025-10-28-11-02-23.png)
...
::: card number="10" title="What to take away" default="open"
::: summary-grid
...
:::
::: arrow-list title="Practical checklist"
