...
subtitle: "Jak použít GitHub Copilot CLI, git worktree a background agenty ve VS Code, když chcete lokálně rozběhnout víc agentů bez toho, aby si navzájem přepisovali soubory."
slug: "coding-agent-background-tasks"
date: "2026-01-06"
language: "cs-CZ"
status: "experimental"
canonical_url: "/2026/coding-agent-background-tasks/"
agent_friendly:
  source: "source.md"
  caveman: "caveman.md"
design:
...
# Coding agenti - paralelní práce agentů na vašich úkolech
...
Paralelní práce agentů dává smysl, ale nechci, aby mi všichni sahali do stejných souborů. Izolace přes worktree a background agenti jsou praktická cesta, jak to dělat lokálně a rychle.
:::

::: group id="cli" title="CLI agent"

::: card number="01" title="GitHub Copilot CLI - agent bez IDE běžící prakticky kdekoli" default="open"
...
::: group id="worktree" title="Paralelní lokální práce"

::: card number="02" title="Manuální použití vícero agentů s Git worktree" default="open"
...
::: group id="vscode" title="Background agent ve VS Code"

::: card number="03" title="Agent HQ: založení background agenta" default="open"
Přímo ve Visual Studio Code můžu kromě interaktivní práce s agentem zvolit nového background agenta.

::: reveal title="Screenshot: volba background agenta"
![Volba background agenta ve VS Code](/images/2026/2026-01-06-07-39-38.png)
:::
...
::: reveal title="Screenshot: automaticky vytvořené worktree"
![Automaticky vytvořené worktree pro background agenta](/images/2026/2026-01-06-07-41-05.png)
:::
...
::: card number="04" title="Sledování, přepínání a handoff agentů"
Práci jednotlivých běžících agentů pak můžu sledovat a různě mezi nimi přepínat.

::: reveal title="Screenshot: seznam běžících agentů"
![Seznam běžících background agentů](/images/2026/2026-01-06-07-42-19.png)
:::
...
::: reveal title="Screenshot: handoff do background agenta"
![Předání práce z interaktivní konverzace do background agenta](/images/2026/2026-01-06-07-47-54.png)
:::
...
::: card number="05" title="Přijetí změn zpět do hlavního workspace"
...
::: reveal title="Screenshot: Keep/Undo a aplikování změn"
![UI pro přijetí nebo vrácení změn background agenta](/images/2026/2026-01-06-07-55-57.png)
:::

Jakmile dám aplikovat, uvidím tuto změnu přímo ve svém hlavním workspace, tedy ve větvi, ve kterém mám VS Code otevřený. 

::: reveal title="Screenshot: změna po aplikování"
![Změna promítnutá do hlavního VS Code workspace](/images/2026/2026-01-06-07-58-18.png)
:::

V seznamu agentů vidím u koho mám nepřečtené zprávy, kolik je tam změn a můžu se rozhodnout co s tím dál.

::: reveal title="Screenshot: stav agentů a nepřečtené zprávy"
![Stav agentů, nepřečtené zprávy a počet změn](/images/2026/2026-01-06-07-59-49.png)
:::
...
::: group id="volba" title="Kdy použít co"

::: card number="06" title="Moje rozhodovací mapa: kdy použít co" default="open"
Kdy co používám? Takhle si to v praxi rozděluji.

::: tabs id="agent-mode-choice"

::: tab id="interactive-agent" title="Interaktivní lokální agent"
...
::: tab id="background-agent" title="Background agent ve VS Code"
...
::: tab id="cloud-agent" title="Cloud agent v GitHub.com"
...
::: summary-grid
- **Interaktivní agent**: když se chci učit, kontrolovat směr nebo diskutovat architekturu.
- **Background agent**: když mám jasné zadání, chci paralelní varianty a výsledek si lokálně vyhodnotím.
- **Cloud agent**: když potřebuji auditovatelný PR proces, spolupráci týmu nebo práci bez běžícího počítače.
- **Worktree**: základní lokální izolace, aby agenti nebojovali o stejné soubory.
:::
:::
...
::: closing
Za mě je dobrý agentický workflow mix: interaktivně tam, kde se rozhoduje, background tam, kde už je zadání jasné, a cloud tam, kde má vzniknout týmově auditovatelný PR.
:::
